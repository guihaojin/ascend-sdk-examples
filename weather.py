...
if __name__ == "__main__":
  print(len(components_weather))
  for component in components_weather:
    if type(component) == definitions.ReadConnector:
      print(component.id)
      print(component.container.record_connection.ByteSize())
      print(component.container.s3.ByteSize() == 0)
      component
    elif type(component) == definitions.Transform:
      print(component.id)
      print(component.operator.spark_function.ByteSize() != 0)
      print(component.input_ids)
    elif type(component) == definitions.WriteConnector:
      print('==============')
      print(component.id)
      print(component.input_id)
      print(component.container.record_connection.ByteSize())
      print(component.container.s3.ByteSize() == 0)
